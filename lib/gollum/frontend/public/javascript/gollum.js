...
$(document).ready(function() {
  ...
  if ($('#minibutton-login').length) {
    $('#minibutton-login').removeClass('jaws');
    $('#minibutton-login').click(function(e) {
      e.preventDefault();
      $.GollumDialog.init({
                            title: 'Login',
                            fields: [
                            ...
                            OK: function( res ) {
                              var n = encodeURIComponent(res['name']);
                              var m = encodeURIComponent(res['mail']);
                              window.location = '/login?name=' + n + '&mail=' + m;
                            }
                          });
    });
  }
